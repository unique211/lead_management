$(document).ready(function() {
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html = '<tr>' +
                        ...
                        '<td   style="white-space:nowrap;text-align:left;padding:10px 10px;">' + totalordvalue + '</td>' +
                        '<td   style="white-space:nowrap;text-align:left;padding:10px 10px;">' + magin + '</td>' +
                ...
                summargin = (parseFloat(summargin) / parseFloat(100000)).toFixed(2);
                sumtop = (parseFloat(sumtop) / parseFloat(100000)).toFixed(2);
    ...
    $(document).on("submit", "#funnel_form", function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "Wonreport/getinvoicewone1",
            async: false,
            data: {
                uid: userid,
                ovmnm: ovmnm,
