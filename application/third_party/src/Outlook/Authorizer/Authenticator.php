...
class Authenticator
{
    ...
    public function __construct($clientId = null, $clientSecret = null, $redirectUri = null)
    {
        ...
        if (is_null($redirectUri)) {
         ...
         //$this->redirectUri = 'https://localhost/lead_management/appointment';
        $this->redirectUri = 'https://localhost/lead_management/googlecalendar/calender_event';
          //$this->redirectUri = 'https://acmesoftware.net/lead_management/googlecalendar/calender_event';
         

      //  $this->redirectUri = "https://localhost/outlook-php/examples/events.php";
    ...
    public function getLoginUrl($scopes = [], $redirectUri = null, $additionalParams = [])
    {
        ...
        $this->scopes = array_merge($scopes, [ "https://outlook.office.com/Calendars.Read",
