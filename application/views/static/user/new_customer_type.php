      ...
      <h3>Customer Type Creation</h3><br>
       ...
       <table class="table table-striped">
          ...
          <!--   <tr>
             ...
             <tr>
                <td colspan="1">
                   <form class=" form-horizontal" method="POST" id="customertype" name="customertype">
                      <fieldset>
                       
                         <div class="form-group">
                            <label class="col-md-4 control-label">Customer Type </label>
                            <div class="col-md-4 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="fa fa-filter"></i></span><input  name="customer" id="customer" autocomplete="off" placeholder="Customer Type" class="form-control" required="true" value="" type="text" maxlength="20"></div><span class=""></span>
                            </div>
...
<script src="assets/js/bootstrap-notify.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/js/myjs/new_customertype.js"></script>
