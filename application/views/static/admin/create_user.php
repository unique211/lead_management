    ...
    label[for*='2']:before {
      ...
      <table class="table table-striped">
         <tbody>
            ...
            <tr>
               <td colspan="1">
                  ...
                  <form class=" form-horizontal" id="finicial_form" method="POST" action="user_creation">
                     <fieldset>
                     <div class="col-lg-12">
         ...
         <label class="lbl" for="tab2">Target Info</label>
                        ...
                        <div class="row">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-6 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-globe"></i></span>
                                       <input id="demo" name="d_region" placeholder="Region" class="tags_input form-control region" type="text" required></div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-6 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-users"></i></span><input id="d_company_name" name="d_company_name" placeholder="Company Name" class="form-control" required="true" value="" type="text"></div><span class="d_company_name1"></span>
                                 </div>
                              </div>
                              <div class="form-group">
                                 ...
                                 <div class="col-md-6 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class=" form-control user_type" id='user_type' name="user_type">
                                          <option value="">--Select--</option>
                                          <option  value="SalesRepresentative">Sales Team</option>
            ...
            <tr>
               <td><input type="submit" class="btn btn-primary" name="create_user" value="Save" onclick="return validate_data()"></td>
