...
class lead_management extends CI_Model
{
  ...
  function insert_user_data($user_id,$emp_id,$user_name,$fisrt_name,$last_name,$email,$password,$phone_number,$user_type,$gender,$google_id,$title,$department,$comments,$user_role,$region,$region_type,$company,$addr)
  {
  	$s="INSERT into user_creation (user_id,emp_id,user_name,first_name,last_name,email,password,
  		phone_num,user_type,gender,title,department,comments,google_calendar_id,user_role,region,region_type,company_name,address) 
		values('$user_id','$emp_id','$user_name','$fisrt_name','$last_name','$email','$password','$phone_number','$user_type','$gender','$title','$department','$comments','$google_id','$user_role','$region','$region_type','$company','$addr')";
  $this->db->query($s);
  }
