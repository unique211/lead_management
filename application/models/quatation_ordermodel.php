...
function getfileterinformation($fromduedate,$toduedate,$satus){
    // $this->db->select('*');    
    // $this->db->from('order_master');
    // if($fromduedate !='' && $toduedate !='' ){
    //     $this->db->where('order_due_date >=',$fromduedate);
    //     $this->db->where('order_due_date <=',$toduedate);
    // }
    // if($satus >0){
    //     $this->db->where('order_status',$satus);
    // }
    // $hasil3=$this->db->get();
    // return $hasil3->result();
